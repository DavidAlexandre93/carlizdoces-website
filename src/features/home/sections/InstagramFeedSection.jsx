...
export default function InstagramFeedSection({ instagramPosts, instagramProfileLink }) {
  ...
  useGSAP(
    (context) => {
      ...
      gsap.from(
        '.instagram-card',
        { y: 26, opacity: 0, duration: 0.75, stagger: 0.08, ease: 'power2.out' },
        context.scope
      );
      gsap.to(
        '.instagram-card img',
        { y: -10, duration: 3.4, repeat: -1, yoyo: true, ease: 'sine.inOut', stagger: 0.12 },
        context.scope
      );
    },
      ...
      <Container maxWidth="xl" className="instagram-section section-alt-pink page-container">
        <header className="instagram-header">
          <Typography component="p" variant="body1">
            Confira nosso perfil e acompanhe as novidades.
          </Typography>
          <Button
            variant="contained"
            color="secondary"
