...
export function useWhatsAppOrderLink({ selectedItems, customizations, orderCustomer, orderPreferences, deliveryMethod, totalItems, totalPrice, BRL }) {
  return useMemo(() => {
  ...
  }, [BRL, customizations, deliveryMethod, orderCustomer.name, orderCustomer.phone, orderPreferences.needsDelivery, orderPreferences.receiveOffers, selectedItems, totalItems, totalPrice])
}
